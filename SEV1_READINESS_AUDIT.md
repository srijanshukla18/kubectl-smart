...
| Current quality gates | `uv run --extra dev pytest --cov=kubectl_smart --cov-report=term-missing` -> `519 passed`, `88%`; ruff gate passed; warning-as-error pytest passed; `demo-smoke.sh` passed; `test.sh` -> `54 passed, 0 failed` |

## Current Evidence Snapshot

- Unit and coverage gate: `519 passed`, `88%`.
- Warning-as-error gate: `519 passed`.
